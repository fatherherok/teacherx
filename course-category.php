			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="courses_search_container">
						<form action="search_course.php" id="courses_search_form" class="courses_search_form d-flex flex-row align-items-center justify-content-start">
...
$get = mysqli_query($con,"SELECT id FROM course WHERE category='$category'   ") or die (mysqli_error());
...
$gett = mysqli_query($con,"SELECT * FROM course WHERE category='$category' 
