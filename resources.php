...
$get = mysqli_query($con,"SELECT id FROM resources  ") or die (mysqli_error());
...
$gett = mysqli_query($con,"SELECT * FROM resources 
									...
									<div class="course_body">
										...
										<div class="course_text">
											...
											<p><?php echo substr($description,0,100); ?>... 
												<?php if($cost != 'Free') : ?>
												<b><a href="resource-pay.php?id=<?php echo $id; ?>">PAY to have access</a></b>
												<?php else : ?>
												<b><a href="resource.php?id=<?php echo $id; ?>" class="" style="">Check Out Free</a></b>
											<?php endif; ?>
											</p>
                ...
                ?>
								...
								<div class="latest d-flex flex-row align-items-start justify-content-start">
									...
									<div class="latest_content">
										<div class="latest_title"><a href="course.php?id=<?php echo $idr; ?>"><?php echo $titler; ?>e</a></div>
