...
$getBlog = mysqli_query($con,"SELECT blog_id FROM blog WHERE $construct AND  approve='yes' ") or die (mysqli_error());
...
$get_Blog = mysqli_query($con,"SELECT * FROM blog WHERE $construct AND approve='yes'
          ...
          <div class="col-md-6 ftco-animate">
            <div class="blog-entry align-self-stretch d-flex">
              ...
              <div class="text p-4 d-block">
                ...
                <h3 class="heading mt-3"><a href="blog_page.php?blog_id=<?php echo $id; ?>"><?php echo strtolower(substr($title,0,100)); ?></a></h3>
