...
<?php include ('./inc/header.inc.php');
                              ...
                              //to check if paid..........
                              $get = mysqli_query($con,"SELECT ordered_id FROM ordered_course WHERE course_id='$id' AND username='$username' ") or die (mysqli_error());
							...
							<div class="col-lg-12 course_col">
								<div class="course">
									...
									<div class="course_body">
										...
										<?php if($material != '') : ?>
										<p style="font-size: 15px; margin-bottom: 20px;"><b>Course Material:</b> <span style=" color: #b81e1e"><?php echo substr($material,0,100); ?> (<?php echo $material_ext; ?>)</span>
										...
										<?php if($link1 != '') : ?>
											 <div class="video-container">
						                      <iframe src="<?php echo $link1; ?>">           </iframe>
						                    </div> 
										<?php endif; ?>

										<?php if($link2 != '') : ?>
											<div class="video-container thumbnail">
						                      <iframe src="<?php echo $link2; ?>">           </iframe>
						                    </div> 
										<?php endif; ?>

										<?php if($link3 != '') : ?>
												<div class="video-container thumbnail">
						                      <iframe src="<?php echo $link3; ?>">           </iframe>
						                    </div> 
										<?php endif; ?>
