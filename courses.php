...
$gett = mysqli_query($con,"SELECT * FROM course 
							...
							<div class="col-lg-6 course_col">
								<div class="course">
									...
									<div class="course_body">
										...
										<div class="course_text">
											<p><?php echo substr($description,0,100); ?>... 
												<?php if($cost != 'Free') : ?>
												<b><a href="course-pay.php?id=<?php echo $id; ?>">PAY to have access</a></b>
												<?php else : ?>
												<b><a href="course.php?id=<?php echo $id; ?>" class="" style="">Check Out Free</a></b>
											<?php endif; ?>
											</p>
									...
									<div class="course_footer">
										...
										<!-- <?php if($cost != 'Free') : ?>
									<div class="text-center"><a href="course-pay.php?id=<?php echo $id; ?>" class="btn btn-primary"  style="background-color: #b81e1e; border: 1px solid #b81e1e;">Pay Now</a></div>
											<?php endif; ?> -->
