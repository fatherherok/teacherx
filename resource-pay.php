...
<?php include ('./inc/header.inc.php');  ?>   
       <h2 class="mb-3 bread text-center">Resource Payment</h2>
 <?php
...
date_default_timezone_set('Africa/Lagos');
 ...
 mysqli_query($con,"INSERT INTO ordered_resource VALUES('', '$current_time', '$username', '$pprice', '$course_id',  '$invoice', 'no', '') ") or die(mysqli_error());	
                ?>
...
callback: function(response){
  window.location = "https://www.teacherx.org/callback2.php?invoice=" + <?php echo $invoice; ?> +"&reference=" + response.reference;
}
...
// $get_query = mysqli_query($con,"SELECT * FROM blog ORDER BY blog_id DESC");  ?>
						<!-- Latest Course -->
						<div class="sidebar_section">
							<div class="sidebar_section_title">Latest Resources</div>
